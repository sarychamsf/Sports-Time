...
function getOffsetSum(e) {
    for (var t = 0, i = 0; e; )
        t += parseInt(e.offsetTop), i += parseInt(e.offsetLeft),
                e = e.offsetParent;
    return {
        top: t,
        left: i
...
window.dhtmlXScheduler = window.scheduler = {
    ...
    a && (window[e] = function (e) {
        ...
        if (e && "object" == typeof e && !e.tagName) {
            ...
            for (var r in dhtmlx)
                t[r] && this[t[r]](dhtmlx[r]);
            for (var r in e)
                t[r] ? this[t[r]](e[r]) : 0 === r.indexOf("on") && this.attachEvent(r, e[r]);
        } else
    ...
    if (this.xmlDoc.responseXML) {
        ...
        if (0 === a.length && -1 != e.indexOf(":"))
            var a = this.xmlDoc.responseXML.getElementsByTagName(e.split(":")[1]);
        i = a[0]
    } else
        i = this.xmlDoc.documentElement;
    if (i)
        return this._retry = !1, i;
    ...
    if (window.name) {
        for (var t = parent.frames[window.name].frameElement.offsetParent, i = 0, a = 0; t; )
            i += t.offsetLeft, a += t.offsetTop, t = t.offsetParent;
    ...
    if (s == XPathResult.FIRST_ORDERED_NODE_TYPE)
    ...
    return this.catches[e] ? this.catches[e](e, t, i) : this.catches.ALL ? this.catches.ALL(e, t, i) : (window.alert("Error type: " + arguments[0] + "\nDescription: " + arguments[1]), null)
        ...
        dtmlXMLLoaderObject.prototype.doXPathOpera = function (e, t) {
            ...
            for (r; r < i.length; r++)
                a = this._getAllNamedChilds(a, i[r]);
            return -1 != i[r - 1].indexOf("[") && (a = this._filterXPath(a, i[r - 1])), a
        }, dtmlXMLLoaderObject.prototype._filterXPath = function (e, t) {
    for (var i = [], t = t.replace(/[^\[]*\[\@/g, "").replace(/[\[\]\@]*/g, ""), a = 0; a < e.length; a++)
        e[a].getAttribute(t) && (i[i.length] = e[a]);
    return i
}, dtmlXMLLoaderObject.prototype._getAllNamedChilds = function (e, t) {
    var i = [];
    _isKHTML && (t = t.toUpperCase());
    for (var a = 0; a < e.length; a++)
        for (var r = 0; r < e[a].childNodes.length; r++)
            _isKHTML ? e[a].childNodes[r].tagName && e[a].childNodes[r].tagName.toUpperCase() == t && (i[i.length] = e[a].childNodes[r]) : e[a].childNodes[r].tagName == t && (i[i.length] = e[a].childNodes[r]);
    return i
    ...
    if (_isIE) {
        ...
        this.XSLProcessor || (this.XSLProcessor = new XSLTProcessor, this.XSLProcessor.importStylesheet(e)), i = this.XSLProcessor.transformToDocument(t);
    return i
        ...
        function () {
            function e(e) {
                ...
                if (window.getComputedStyle) {
                    ...
                    e.currentStyle && (t = e.currentStyle.display, i = e.currentStyle.visibility);
                var r = !1,
    ...
    return t.apply(e)
        ...
        function () {
            ...
            function s(t, i, r) {
                ...
                if (t.buttons)
                    for (var _ = 0; _ < t.buttons.length; _++)
                        d += a(t.buttons[_], _);
    ...
    markRow: function (e, t, i) {
        ...
        if (r && (a = this.styles[r], t = !0), this.callEvent("onRowMark", [e, t, i, r]) && (a = this.styles[t ? i : "clear"] + a,
            ...
            for (var s = 0; s < r.details.length; s++)
                r.details[s] && this.obj[this._methods[1]](e, s, a)
        }
    },
    getState: function (e) {
    ...
    serialize: function (e, t) {
        ...
        var i = [],
                a = [];
        for (var r in e)
            e.hasOwnProperty(r) && (i.push(this.serialize_one(e[r], r + this.post_delim)),
                    a.push(r));
    ...
    _sendData: function (e, t) {
        if (e) {
            ...
            if ("GET" == this._tMode)
                i.loadXML(a + (-1 != a.indexOf("?") ? "&" : "?") + this.serialize(e, t));
            else if ("POST" == this._tMode)
                i.loadXML(a, !0, this.serialize(e, t));
    ...
    afterUpdateCallback: function (e, t, i, a) {
        var r = e,
                s = "error" != i && "invalid" != i;
        if (s || this.set_invalid(e, i), this._uActions && this._uActions[i] && !this._uActions[i](a))
    ...
    afterUpdate: function (e, t, i) {
        ...
        if (t.getXMLTopNode("data"), !t.xmlDoc.responseXML)
            return this.obj && this.obj.callEvent && this.obj.callEvent("onSaveError", [i, t.xmlDoc]), this.cleanUpdate(i);
    ...
    dhx_cal_data: function (e) {
        ...
        if (e = e || event, i) {
            if (!scheduler.callEvent("onClick", [i, e]) || scheduler.config.readonly)
                return
        } else
        ...
        if (i && scheduler.config.select) {
            ...
            scheduler._close_not_saved(), (new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler.unselect();
    },
    ...
    if (t = t || e.target || e.srcElement, !this.config.readonly) {
        ...
        switch (i) {
            ...
            case "dhx_cal_event_clear":
                ...
                if (!this.callEvent("onDblClick", [a, e]))
                    return;
    ...
    var t = 0;
    if (this._cols) {
        for (var i = 0, a = 0; i + this._cols[a] < e && a < this._cols.length; )
            i += this._cols[a], a++;
    ...
    if (this._drag_mode) {
        ...
        if (this._is_pos_changed(this._drag_pos, t)) {
            ...
            if (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]), d = d || {
                ...
                i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (i += 1e3 * this.date.time_part(l.start_date)),
                ...
                if (i = l.start_date.valueOf(), a = l.end_date.valueOf(), this._table_view) {
                    ...
                    if ("month" == this._mode)
                        ...
                        t.resize_from_start ? i = scheduler._correct_drag_start_date(o) : a = scheduler._correct_drag_end_date(o, 0)
                } else {
                ...
                if ("new-size" == this._drag_mode)
                    ...
                    i >= a && (a = i + 6e4 * this.config.time_step)
            }
            var g = new Date(a - 1),
                    v = new Date(i);
            if ("move" == this._drag_mode && scheduler.config.limit_drag_out && (+v < +scheduler._min_date || +a > +scheduler._max_date)) {
                if (+l.start_date < +scheduler._min_date || +l.end_date > +scheduler._max_date)
                    v = new Date(l.start_date), a = new Date(l.end_date);
                else {
                    var f = a - v;
    ...
    if (2 != e.button && !this.config.readonly && !this._drag_mode) {
        ...
        switch (i) {
            ...
            case "":
                ...
                break;
            default:
                if ((!scheduler.checkEvent("onMouseDown") || scheduler.callEvent("onMouseDown", [i])) && t.parentNode && t != this && "dhx_body" != i)
                    return scheduler._on_mouse_down(e, t.parentNode);
        ...
        if (this._drag_mode) {
            ...
            if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [r, this._drag_mode, e])) {
                if (this._drag_id = r, (this._edit_id != this._drag_id || this._edit_id && "create" == this._drag_mode) && this._close_not_saved(), !this._drag_mode)
                    return;
            ...
            if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                ...
                if (this.callEvent("onBeforeEventChanged", [r, e, s, this._drag_event]))
                    if (this._drag_id = this._drag_mode = null, s && this.config.edit_on_create) {
                        if (this.unselect(), this._new_event = new Date, this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(t)))
                            return scheduler.callEvent("onDragEnd", [t, i, e]), this.showLightbox(t);
                        this._drag_pos = !0, this._select_id = this._edit_id = t
                    } else
                        this._new_event || this.callEvent(s ? "onEventAdded" : "onEventChanged", [t, this.getEvent(t)]);
                else
                    s ? this.deleteEvent(r.id, !0) : (this._drag_event._dhx_changed = !1,
    ...
    for (var s = r - this._ignores_detected, n = 0; r > n; n++)
        this._ignores[n] ? (this._cols[n] = 0, s++) : this._cols[n] = Math.floor(a / (s - n)),
    ...
    if (this.templates[this._mode + "_date"]) {
        ...
        if (this._els.dhx_cal_date[0].innerHTML = l, this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], l), this._max_date = d, scheduler._render_scales(e, t), this._table_view)
            this._reset_month_scale(t, n, s);
    ...
    if (s)
        for (var n = new Date(e), d = 0; t > d; d++)
            s(n) && (this._ignores_detected += 1, this._ignores[d] = !0, r && t++), n = scheduler.date.add(n, a, i), scheduler.date[i + "_start"] && (n = scheduler.date[i + "_start"](n))
    ...
    for (var g = [], o = 0; a > o; o++) {
        ...
        for (var f = Math.max(r(o) - scheduler.xy.month_head_height, 0), m = 0; 7 > m; m++) {
            ...
            var x = "dhx_month_body",
                    y = "dhx_month_head";
            if (0 === m && this.config.left_border && (x += " dhx_month_body_border", y += " dhx_month_head_border"), this._ignores_detected && this._ignores[m])
                p.appendChild(document.createElement("div")), p.appendChild(document.createElement("div"));
            else {
    ...
    if (e && "object" == typeof e) {
        for (r = {}, a = [Array, Date, Number, String, Boolean], i = 0; i < a.length; i++)
            e instanceof a[i] && (r = i ? new a[i](e) : new a[i]);
        t.push(e, r);
        for (i in e)
            Object.prototype.hasOwnProperty.apply(e, [i]) && (r[i] = scheduler._lame_clone(e[i], t));
    }
    return r || e
    ...
    str_to_date: function (e, t) {
        for (var i = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", a = e.match(/%[a-zA-Z]/g), r = 0; r < a.length; r++)
            switch (a[r]) {
                case "%j":
                case "%d":
                    i += "set[2]=temp[" + r + "]||1;";
    ...
    if (e != t) {
        ...
        function () {
            for (var e = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], t = function (e) {
                ...
                scheduler["getEvent" + e[a + 1]] = t(e[a]), scheduler["setEvent" + e[a + 1]] = i(e[a])
    ...
    for (var a = 0, r = e.length; r > a; a++)
        this._recalculate_timed(e[a]);
    if (this.config.multi_day && !this._table_view) {
        for (var s = [], n = [], a = 0; a < e.length; a++)
            this._is_main_area_event(e[a]) ? s.push(e[a]) : n.push(e[a]);
    ...
    for (var r = 0; r < e.length; r++) {
        var s = e[r],
                ...
                l = n.getHours(),
                o = d.getHours();
        if (s._sday = this._get_event_sday(s), this._ignores[s._sday])
            e.splice(r, 1), r--;
        else {
    ...
    if (!t) {
        for (var r = 0; r < e.length; r++)
            e[r]._count = i[e[r]._sday].max_count;
        for (var r = 0; r < a.length; r++)
            a[r]._count = i[a[r]._sday].max_count
    }
    return e
    ...
    for (var i, a = [], r = [
        ...
        if (o._sday = g % n, !this._ignores[o._sday] || !o._timed) {
            ...
            for (f = 0; f < m.length && !(m[f]._eday <= o._sday); f++)
                ;
            if (o._sorder && t || (o._sorder = f), o._sday + o._length <= n)
                i = null, a.push(o), m[f] = o, s[o._sweek] = m.length - 1, o._first_chunk = _.first_chunk, o._last_chunk = _.last_chunk;
            else {
    ...
    if (!(e._sday < 0)) {
        ...
        if (a) {
            ...
            if (0 !== this.xy.menu_width && this._select_id == e.id) {
                ...
                for (var m, p = this.config["icons_" + (this._edit_id == e.id ? "edit" : "select")], b = "", x = e.color ? "background-color: " + e.color + ";" : "", y = e.textColor ? "color: " + e.textColor + ";" : "", w = 0; w < p.length; w++)
                    m = this._waiAria.eventMenuAttrString(p[w]),
    ...
    if (!l && scheduler.renderEvent(f, e, a, r, n, d))
        return f;
    f = o.firstChild;
    ...
    if (e = e || this._load_url) {
        ...
        if (t = t || this._date, this._load_mode) {
            ...
            for (var r = !0; i < this._max_date; )
                i = this.date.add(i, 1, this._load_mode), this._loaded[a(t)] && r ? t = this.date.add(t, 1, this._load_mode) : r = !1;
            var s = i;
            do
                i = s, s = this.date.add(i, -1, this._load_mode);
            while (s > t && this._loaded[a(s)]);
            if (t >= i)
                return !1;
            for (dhtmlxAjax.get(e + "&from=" + a(t) + "&to=" + a(i), function(e) {
            scheduler.on_load(e)
            }); i > t; )
                this._loaded[a(t)] = !0, t = this.date.add(t, 1, this._load_mode);
        } else
    ...
    select: {
        render: function (e) {
            for (var t = (e.height || "23") + "px", i = "<div class='dhx_cal_ltext' style='height:" + t + ";'><select style='width:100%;'>", a = 0; a < e.options.length; a++)
            ...
            for (var n = "", d = 0; d < t.length; d++) {
                ...
                switch (l) {
                    case "%Y":
                        ...
                        for (var h = a.getFullYear() - 5, _ = 0; 10 > _; _++)
                            o += "<option value='" + (h + _) + "'>" + (h + _) + "</option>";
                        break;
                    case "%m":
                        e._time_format_order[2] = d;
                        for (var _ = 1; 12 > _; _++)
                            o += "<option value='" + _ + "'>" + this.locale.date.month_full[_] + "</option>";
                        break;
                    case "%d":
                        e._time_format_order[1] = d;
                        for (var _ = 1; 32 > _; _++)
                            o += "<option value='" + _ + "'>" + _ + "</option>";
                        break;
                    case "%H:%i":
            ...
            switch (i) {
                ...
                default:
                    if (t.getAttribute("dhx_button"))
                        scheduler.callEvent("onLightboxButton", [i, t, e]);
                    else {
                        var r, s, n;
    ...
    if (!this._lightbox) {
        ...
        for (var t = this._lightbox_template, i = this.config.buttons_left, a = "", r = 0; r < i.length; r++)
            a = this._waiAria.lightboxButtonAttrString(i[r]), t += "<div " + a + " class='dhx_btn_set dhx_left_btn_set " + i[r] + "_set'><div dhx_button='1' class='" + i[r] + "'></div><div>" + scheduler.locale.labels[i[r]] + "</div></div>";
        i = this.config.buttons_right;
        for (var r = 0; r < i.length; r++)
            a = this._waiAria.lightboxButtonAttrString(i[r]), t += "<div " + a + " class='dhx_btn_set dhx_right_btn_set " + i[r] + "_set' style='float:right;'><div dhx_button='1' class='" + i[r] + "'></div><div>" + scheduler.locale.labels[i[r]] + "</div></div>";
    ...
    function r(e, t, i, a) {
        if (e && t) {
            for (var r = e.target; r && r != scheduler._obj; )
                r = r.parentNode;
            if (r == scheduler._obj) {
    ...
    function s(e) {
        ...
        "create" == t && i && (scheduler.render_view_data = function () {
            for (var e = scheduler.getState().drag_id, t = scheduler.getEvent(e), a = i.y_property, r = scheduler.getEvents(t.start_date, t.end_date), s = 0; s < r.length; s++)
                r[s][a] != t[a] && (r.splice(s, 1), s--);
    ...
    a(document.body, e[0], function (e) {
        if (!i(e)) {
            ...
            if (a) {
                if (h)
                    return s(a), scheduler._update_global_tip(), e.preventDefault && e.preventDefault(),
                            e.cancelBubble = !0, !1;
                if (l = t(e), c)
                    return l ? void((d.target != l.target || Math.abs(d.pageX - l.pageX) > 5 || Math.abs(d.pageY - l.pageY) > 5) && (_ = !0, clearTimeout(o))) : void(_ = !0)
            }
        }
        ...
        if (!i(e)) {
            ...
            var r = new Date;
            if (!_ && !h && 250 > r - u)
                return scheduler._click.dhx_cal_data(a), window.setTimeout(function () {
    ...
    e._methods = ["_set_event_text_style", "", "_dp_change_event_id", "_dp_hook_delete"], this._dp_change_event_id = function (e, t) {
        ...
        a = a || "", i = i || {};
        for (var r in t)
            0 !== r.indexOf("_") && (t[r] && t[r].getUTCFullYear ? i[a + r] = this.obj.templates.xml_format(t[r]) : t[r] && "object" == typeof t[r] ? e._objToJson(t[r], i, a + r + ".") : i[a + r] = t[r]);
        return i
    ...
    for (var a in t)
        "undefined" == typeof e[a] && (e[a] = t[a][i])
            ...
            if (scheduler.templates.month_day = function (i) {
                ...
                for (var i = scheduler._els.dhx_cal_navline[0].getElementsByTagName("div"), a = null, r = 211, s = 0; s < i.length; s++) {
                    ...
                    if (d)
                        ...
                        0 === (n.className || "").indexOf("dhx_minical_icon") && n.parentNode == scheduler._els.dhx_cal_navline[0] && (a = n)
                }
                a && (a.style.left = r + "px")
            }
        }), scheduler._skin_init = function () {}
...
//# sourceMappingURL=sources/dhtmlxscheduler.js.mapS