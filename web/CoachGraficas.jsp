                                    ...
                                    <div id="TAblaJQ">
                                        <center>
                                            <div style="width:100px; height: 50px">
                                                <SELECT class="form-control" name="FehcasF" SIZE="1" id="FehcasF" onchange="FiltroEstilos2('<%=nomDep%>')"></SELECT>
                                                <SELECT class="form-control" name="EstilosF" SIZE="1" id="EstilosF" onchange="DatosFiltro2('<%=nomDep%>')"></SELECT> 
                                            </div>
                                        </center>
                                        <br>
                                        <br>
                                        <center>
                                            <button class="btn btn-info btn-round" onclick="GraficaEspalda(2,'<%=nomDep%>')">Grafica</button>
                                        </center>
                                        <br>
                                        <br><br><br>
